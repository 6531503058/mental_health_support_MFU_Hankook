...
class ChoosedTherapist extends StatelessWidget {
  final String therapistFrontId;

  const ChoosedTherapist({super.key, required this.therapistFrontId});
                              ...
                              children: times.map<Widget>((time) {
                                return ElevatedButton(
                                  onPressed: () {
                                     Navigator.push(
                       context,
                      MaterialPageRoute(builder: (context) => ConfirmBooking(key: key, therapistFrontId: this.therapistFrontId , day: day, time: time,)));
                                  },
                                  child:
